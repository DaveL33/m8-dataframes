...
mean.grant <- mean(grants$total_amount) # / length(grants)
...
largest.org <- grants$organization[grants$total_amount == largest.grant]

# Which organization received the smallest grant?
smallest.org <- grants$organization[grants$total_amount == smallest.grant]
